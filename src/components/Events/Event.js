...
const Event = () => {
    ...
    return (
        <div className="min-h-screen  text-white py-8">
            {/* Map Section */}
            <div className="w-11/12 mx-auto h-96 mb-8">
                <iframe
                ...
                {events.map((event, index) => (
                    ...
                    >
                        ...
                        <div className="w-full  mt-4 flex items-center">
                            {/* Date */}
                            <div className="bg-gray-800 border-[3px] text-white font-bold text-sm w-16 h-16 flex items-center justify-center rounded-3xl mr-4">
                                {event.date}
                            </div>
