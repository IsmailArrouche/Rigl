...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Sidebar */}
      <div
        className={`fixed top-20 left-4 h-[calc(100vh-4rem)] w-64 p-4 bg-gray-100 dark:bg-[#293145] overflow-y-auto scrollbar-t scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-400 z-40 ${
