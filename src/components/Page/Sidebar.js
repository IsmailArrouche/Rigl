  ...
  return (
    <div className="w-[17rem] bg-gray-100 dark:bg-[#293145]">
      ...
      <div
        ...
        } top-16 md:top-20 h-[calc(100vh-4rem)] md:h-[calc(100vh-4rem)] w-full sm:w-64 md:w-64 p-4 bg-white dark:bg-[#293145] overflow-y-auto scrollbar-t scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 z-40 transition-all duration-300`}
        style={{ zIndex: 1000 }}
      >
        {/* New Feeds Section */}
        <div className="mb-8">
