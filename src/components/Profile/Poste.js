...
const SocialPost = () => {
  ...
  return (
    <div className="ml-8 sm:w-1/2 lg:w-[620px] lg:max-h-[610px] mt-6 flex flex-wrap gap-4 justify-center">
      {posts.map((post) => (
        <div
          key={post.id}
          className="card w-full shadow-sm rounded-xl border-0 p-3 sm:p-4 mb-3 mx-auto bg-white dark:bg-[#1B2136] dark:text-[#FFFFFF]"
        >
          {/* En-tête */}
          <div className="card-body p-0 relative">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <img src={avatar} alt="avatar" className="shadow-sm rounded-full w-8 h-8 sm:w-10 sm:h-10" />
